                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3 mt-3">
                            <label for="specialist_category" class="col-md-4 col-form-label text-md-end">{{ __('specialist_category') }}</label>
                            <div class="col-md-6">
                                <select class="form-select" name="specialist_category"  aria-label="Default select example">
